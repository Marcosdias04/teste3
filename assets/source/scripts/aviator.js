...
function generateMessages() {
    ...
    setTimeout(function () {
        var valorNormal = (Math.random() * (1.90) + 1.00).toFixed(2);
        var valorAutomatico2 = (Math.random() * 7) + 1;
        addMessage(`Tire no ${valorNormal}x <br><br>Válido até ${obterHorarioAtual()}!`);
        var chat = document.getElementById("chat");

        // Create and append the image with a class
